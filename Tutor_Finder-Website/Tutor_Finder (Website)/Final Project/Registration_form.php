...
// education table
$universityname = mysqli_real_escape_string($link, $_REQUEST['university_name']);
$department_name = mysqli_real_escape_string($link, $_REQUEST['department_name']);
$uvcgpa = mysqli_real_escape_string($link, $_REQUEST['uvcgpa']);
$uv_from_to = mysqli_real_escape_string($link, $_REQUEST['uv_from_to']);
$college_name = mysqli_real_escape_string($link, $_REQUEST['college_name']);
$clg_dept = mysqli_real_escape_string($link, $_REQUEST['clg_dept']);
$clg_gpa = mysqli_real_escape_string($link, $_REQUEST['clg_gpa']);
$clg_from_to = mysqli_real_escape_string($link, $_REQUEST['uv_from_to']);
$scl_name = mysqli_real_escape_string($link, $_REQUEST['scl_name']);
$scl_dept = mysqli_real_escape_string($link, $_REQUEST['scl_dept']);
$scl_gpa = mysqli_real_escape_string($link, $_REQUEST['scl_gpa']);
$scl_from_to = mysqli_real_escape_string($link, $_REQUEST['uv_from_to']);
...
// attempt insert query into person table 
$sql = "INSERT INTO tutor (firstname, lastname, email, phonenumber) VALUES ('$first_name', '$last_name', '$email', '$phone_number')";


// executing insertion in person table
...
// attempt insert query into person_is (gender) table 
$sql = "INSERT INTO Tutors_gender (Tutor_ID, Gender_id) VALUES ('$last_id', '$id')";


// executing insertion in person_is(gender) table
if(mysqli_query($link, $sql))
{
    echo "Records added successfully.";
} 
...
// attempt insert query into lives in (location) table 
$sql = "INSERT INTO tutor_livesin ( Tutor_ID , location_id) VALUES ('$last_id', '$lid')";
...
// attempt insert query into education  table 
$sql = "INSERT INTO education (Tutor_ID, University_name, University_dept, University_result, University_from_to, College_name, College_dept, College_result, College_from_to, School_name, School_dept, School_result, School_from_to ) VALUES ('$last_id','$universityname', '$department_name', '$uvcgpa', '$uv_from_to', '$college_name', '$clg_dept', '$clg_gpa', '$clg_from_to', '$scl_name', '$scl_dept', '$scl_gpa', '$scl_from_to')";
...
$sql = "INSERT INTO tutor_schedule ( Tutor_ID , day_id) VALUES ('$last_id', '$dd')";
...
$sql = "INSERT INTO tutor_schedule ( Tutor_ID , day_id) VALUES ('$last_id', '$dd2')";
...
$sql = "INSERT INTO tutor_schedule ( Tutor_ID , day_id) VALUES ('$last_id', '$dd3')";
...
$sql = "INSERT INTO tutor_teaches ( Tutor_ID , subject_id) VALUES ('$last_id', '$ss')";
...
$sql = "INSERT INTO tutor_teaches ( Tutor_ID , subject_id) VALUES ('$last_id', '$ss2')";
...
$sql = "INSERT INTO tutor_teaches ( Tutor_ID , subject_id) VALUES ('$last_id', '$ss3')";
...
<body>
	<center><h1>&nbsp;Yout User ID Is :  <?php echo $last_id; ?>&nbsp;</h1></center>
	<center><h3><h4>Important :</h4> Your need to save this id for updating or deleting your data in future.</h3></center>
    <center><h3 style="background-color: Tomato"><h4>Open Account to view your Profile :</h4><a href="resigter.php">Open Account</a></h3></center>
