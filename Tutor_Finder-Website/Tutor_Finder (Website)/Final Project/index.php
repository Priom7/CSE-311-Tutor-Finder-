<?php
 ...
 if( isset($_POST['btn-login']) ) { 
  ...
  if (!$error) {
   ...
   $res=mysql_query("SELECT Tutor_ID, userName, userPass FROM users WHERE userEmail='$user_email'");
   $row=mysql_fetch_array($res);
   $count = mysql_num_rows($res); // if uname/pass correct it returns must be 1 row
   
   if( $count == 1 && $row['userPass']==$password ) {
    $_SESSION['user'] = $row['Tutor_ID'];
    header("Location: home.php");
   } else {
...
<h3 style="background-color: rgba(255, 99, 71, 0.6)"><center><div class="container">
 ...
 <div id="login-form">
   ...
   ?>
            ...
            <div class="form-group">
             ...
             <input type="email" name="useremail" class="form-control" placeholder="Your Email" value="<?php echo $user_email; ?>" maxlength="40" />
                </div>
